...
class FilterChars {
    ...
    getCharIcon(DevNicknames) {
        return("https://eliya-bot.herokuapp.com/img/assets/chars/" + DevNicknames + "/square_0.png")
    }

    getCharArt(DevNicknames) {
        return("https://eliya-bot.herokuapp.com/img/assets/chars/" + DevNicknames + "/full_shot_0.png")
    }
