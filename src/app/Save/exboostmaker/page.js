...
const exboosts = require('../Modals/ex_boost.json');
const exstatus = require('../Modals/ex_status.json');
import exBoostConverting from '../Modals/exBoostConverting';
...
function App() {
    ...
    return (
        <div>
            Testing out the unit edit layout
            <EquipLevel level={3}/>
            <div>
